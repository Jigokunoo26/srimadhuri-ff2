      ...
      <div className="container">
        ...
        >
          ...
          <div className="reviews-summary">
            <div style={{ fontSize: '0.72rem', color: 'var(--amber-light)', textTransform: 'uppercase', letterSpacing: '0.22em', marginBottom: '1.25rem', fontWeight: 600 }}>
              Verified on Google
            </div>

            <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', marginBottom: '0.5rem' }}>
              <span style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(3.2rem, 8vw, 4rem)', color: 'var(--bone)', fontWeight: 500, lineHeight: 1 }}>
            ...
            <div style={{ marginTop: '0.85rem', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            ...
            {reviewUrl && (
              <a
                ...
                style={{ marginTop: '1.5rem', gap: '8px', width: 'auto', display: 'inline-flex' }}
              >
          ...
          <div style={{ display: 'grid', gap: '1rem' }}>
            {topReviews.length === 0 ? (
              ...
              topReviews.map((r, i) => (
                <article key={i} className="surface" style={{ padding: '1.35rem 1.5rem', borderRadius: 'var(--radius-md)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.65rem', flexWrap: 'wrap', gap: '8px' }}>
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.05rem', color: 'var(--bone)', fontWeight: 500 }}>
                          {r.name}
                        </span>
        ...
        <div style={{ marginTop: '3.5rem', overflowX: 'auto' }}>
          <div style={{ fontSize: '0.72rem', color: 'var(--amber-light)', textTransform: 'uppercase', letterSpacing: '0.22em', marginBottom: '1.25rem', textAlign: 'center', fontWeight: 600 }}>
