...
export const initialStoreInfo = {
  ...
  map_embed_url: "https://maps.google.com/maps?q=17.226191,80.1508772+(Sri+Madhuri's+Makeovers+%26+Beauty+Saloon)&t=&z=17&ie=UTF8&iwloc=B&output=embed",
  map_lat: 17.226191,
  map_lng: 80.1508772,
  map_zoom: 17,
  map_iframe_html: `<iframe src="https://maps.google.com/maps?q=17.226191,80.1508772+(Sri+Madhuri's+Makeovers+%26+Beauty+Saloon)&t=&z=17&ie=UTF8&iwloc=B&output=embed" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>`
};
